...
<div class="content">
    <div class="container-fluid">
            ...
            <div class="row align-items-center">     
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Editar recetas</a></li>
                    </ol>
        ...
        <form action="{$getUrl}recetas/proceso/editar" method="post" class="formulario" accept-charset="utf-8" enctype="multipart/form-data">
