...
<div class="content">
    <div class="container-fluid">
        ...
        <form action="{$getUrl}usuario/proceso/editar" method="post" class="formulario" accept-charset="utf-8" enctype="multipart/form-data">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <label>Usuario</label>
                            <input type="text" class="form-control" maxlength="30" name="usuario" id="defaultconfig" value="{if isset($prefil_usuario)}{$prefil_usuario}{/if}" autocomplete="off"/>
