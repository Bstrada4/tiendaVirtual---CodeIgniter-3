<?php
/* Smarty version 3.1.36, created on 2020-08-22 22:07:53
  from '/home/s99ts68oq3kj/public_html/test/application/views/dashboard/page/panel_maps.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_5f4197398abd41_75782998',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a0dadcc4b0b5ce846d5d98a5b8a0977f70eb6c00' => 
    array (
      0 => '/home/s99ts68oq3kj/public_html/test/application/views/dashboard/page/panel_maps.tpl',
      1 => 1595822192,
      2 => 'file',
    ),
  ),
...
function content_5f4197398abd41_75782998 (Smarty_Internal_Template $_smarty_tpl) {
...
}?>" autocomplete="off" placeholder="Longitud"/></div></div><div class="card-body"><label>Dirección 2:</label><input type="text" class="form-control" maxlength="25" name="latitud_2" value="<?php if ((isset($_smarty_tpl->tpl_vars['latitud_2']->value))) {
...
}?>" autocomplete="off" placeholder="Longitud"/></div></div><div class="card-body"><label>Dirección 3:</label><input type="text" class="form-control" maxlength="25" name="latitud_3" value="<?php if ((isset($_smarty_tpl->tpl_vars['latitud_3']->value))) {
...
}?>" autocomplete="off" placeholder="Longitud"/></div></div><div class="card-body"><label>Dirección 4:</label><input type="text" class="form-control" maxlength="25" name="latitud_4" value="<?php if ((isset($_smarty_tpl->tpl_vars['latitud_4']->value))) {
...
}?>" autocomplete="off" placeholder="Longitud"/></div></div><div class="card-body"><label>Dirección 5:</label><input type="text" class="form-control" maxlength="25" name="latitud_5" value="<?php if ((isset($_smarty_tpl->tpl_vars['latitud_5']->value))) {
...
}?>" autocomplete="off" placeholder="Longitud"/></div></div><div class="card-body"><label>Dirección 6:</label><input type="text" class="form-control" maxlength="25" name="latitud_6" value="<?php if ((isset($_smarty_tpl->tpl_vars['latitud_6']->value))) {
