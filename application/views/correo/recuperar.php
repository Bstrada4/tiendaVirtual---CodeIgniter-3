										...
										<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
													...
													<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="left" class="container">
														...
														<tr>
															...
															<td style="border-radius: 3px;" bgcolor="#000000">
																...
																<a class="btn" href="<?php echo $activar; ?>" target="_blank" style="font-size: 18px; font-family: 'Source Sans Pro', sans-serif; color: #ffffff; text-decoration: none; text-decoration: none; padding: 10px 20px; border-radius: 2px; border: 1px solid #000000; display: inline-block;">RECUPERAR CUENTA</a>
											...
											<tr>
												...
												<td style="padding-bottom: 15px; font-family: 'Source Sans Pro', sans-serif; font-size: 18px; line-height: 24px; color: #1B2733;">
													...
													Si no puede hacer clic en el boton puede copiar el siguiente enlace: <br>

													<span><?php echo $activar; ?></span>
