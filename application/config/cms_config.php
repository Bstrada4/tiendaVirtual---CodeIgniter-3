...
// CONFIGURACION WEB
$config[ 'default_directory_web' ] = 'web';

// CONFIGURACION SISTEMA
$config[ 'default_directory_system' ] = 'dashboard';
$config[ 'default_title_system' ] = 'Sistema Administración';
$config[ 'default_email_system' ] = 'bstrada4@gmail.com';
$config[ 'default_error_system' ] = 5;
$config[ 'default_block_system' ] = 2;
$config[ 'default_captcha_system' ] = 240;
$config[ 'default_footer_system' ] = 'www.miweb.com';
$config[ 'default_web_system' ] = 'https://www.miweb.com';
$config[ 'default_logo_system' ] = 'logo_defecto.png';
$config[ 'default_favicon_system' ] = 'favicon_defecto.png';
