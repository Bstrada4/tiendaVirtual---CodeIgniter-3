...
class Model_DB {
    ...
    public function denegarInfo($id){
        $columnaDatos = array(
    ...
    public function permitirInfo($id){
        $columnaDatos = array(
    ...
    public function mostrarDatos($condicion = array(), $limite = FALSE, $offset = FALSE ){
        $this->obtieneConsulta();
        if( (isset($condicion)) && (is_array($condicion)) ){
            if( (isset($condicion['and'])) || (isset($condicion['or'])) ){
                if( (isset($condicion['and'])) && (count($condicion['and']) > 0) ){
    ...
    public function buscarDatos($condicion = array(), $limite = FALSE, $offset = FALSE ){
        $this->obtieneConsulta();
        if( (isset($condicion)) && (is_array($condicion)) ){
            if( (isset($condicion['and'])) || (isset($condicion['or'])) ){
                if( (isset($condicion['and'])) && (count($condicion['and']) > 0) ){
    ...
    public function buscarPalabraClave($condicion = array(), $limite = FALSE, $offset = FALSE ){
        $this->obtieneConsulta();
        if( (isset($condicion)) && (is_array($condicion)) ){
            if( (isset($condicion['and'])) || (isset($condicion['or'])) ){
                if( (isset($condicion['and'])) && (count($condicion['and']) > 0) ){
    ...
    public function existeInfo($columna, $valor, $id = FALSE){
        if($id === FALSE){
            $this->ci->db->select();
    ...
    public function existeMuchaInfo($info, $id = FALSE){
        if($id === FALSE){
            $this->ci->db->select();
            $this->ci->db->from($this->tabla);
            foreach($info as $k => $v){
